...
(function () {
  ...
  const projects = [
    ...
    },
    {
      ...
      year: '2024',
      desc: 'Complete brand identity and visual strategy for SnowandBelle, an artisan boutique. We defined the brand story, visual language, and high-end positioning to attract premium clientele.',
      result: 'Premium brand positioning & unique visual identity',
      tags: ['Brand Strategy', 'Logo Design', 'Visual Identity', 'Art Direction'],
